...
namespace InfoParse {
  Option_<bool>::Option_(std::string longName, char shortName, bool* exporter)
          : longName(std::move(longName)),
            shortName(shortName),
            exporter(exporter) {}

  Option_<bool>::Option_(const std::string& name, bool* exporter)
          : longName(name),
            shortName(name[0]),
            exporter(exporter) {}
  ...
  bool Option_<bool>::operator==(const Option_& rhs) const {
  ...
  bool Option_<bool>::operator==(const std::string& name) const {
  ...
  bool Option_<bool>::operator==(const char* cname) const {
  ...
  bool Option_<bool>::operator==(const char c) const {
      return shortName == c;
  }
